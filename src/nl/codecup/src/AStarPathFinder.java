...
public class AStarPathFinder implements IPathFinder {
    ...
    private String[] getShortestPathBetweenGroups(Group group1, Group group2) {
        ...
        for (String coordinate1 : group1.getCoordinates()) {
            for (String coordinate2 : group2.getCoordinates()) {
                String[] temp = execute(split(coordinate1), split(coordinate2), new ArrayList<String>(unvisitedNodes), new ArrayList<String>());
    ...
    private String findShortestPossiblePath(Group start, List<Group> sortedList) {
        ...
        // TODO GOT NULLPOINTER..
        return list.length > 0 ? list[0] : null;
    }

    private String[] execute(String[] current, String[] end, List<String> unvisited, List<String> path) {
        ...
        for (int i = 0; i < neighbors.length; i++) {
            ...
            if (neighbor != null && unvisitedRef.contains(neighbor)) {
                ...
                if (board.isBlankSpace(x, y)) {
                     ...
                     */
                    returnValue = assignPath(returnValue, execute(coords, end, unvisited, newPath));
