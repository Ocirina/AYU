...
public class Board {
	...
	private int[][] boardGrid = new int[][] {
			{ NONE, BLACK, NONE, NONE, BLACK, BLACK, BLACK, NONE, NONE, NONE,
					NONE },
			{ NONE, NONE, NONE, NONE, NONE, WHITE, WHITE, WHITE, WHITE, WHITE,
					WHITE },
			{ NONE, BLACK, NONE, NONE, BLACK, BLACK, BLACK, BLACK, BLACK, NONE,
					NONE },
			{ NONE, NONE, NONE, NONE, NONE, WHITE, WHITE, WHITE, WHITE, WHITE,
					WHITE },
			{ NONE, BLACK, BLACK, NONE, NONE, BLACK, NONE, BLACK, NONE, BLACK,
					NONE },
			{ NONE, NONE, NONE, NONE, NONE, WHITE, WHITE, WHITE, WHITE, WHITE,
					WHITE },
			{ NONE, BLACK, WHITE, NONE, NONE, NONE, NONE, NONE, NONE, NONE,
					NONE },
			{ NONE, NONE, WHITE, BLACK, WHITE, BLACK, NONE, NONE, WHITE, WHITE,
					WHITE },
			{ NONE, BLACK, BLACK, BLACK, NONE, BLACK, NONE, BLACK, BLACK,
					BLACK, NONE },
			{ WHITE, BLACK, WHITE, BLACK, WHITE, NONE, WHITE, BLACK, WHITE,
					BLACK, WHITE },
			{ NONE, NONE, NONE, NONE, NONE, NONE, NONE, BLACK, NONE, NONE, NONE } };
	...
	public boolean hasNeighbor(int x, int y) {
		return ((y + 1 < SIZE && this.boardGrid[x][y + 1] == Player.piece)
				...
				|| (y - 1 >= 0 && this.boardGrid[x][y - 1] == Player.piece) || (x - 1 >= 0 && this.boardGrid[x - 1][y] == Player.piece));
	}
